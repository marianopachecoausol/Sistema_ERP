...
Begin VB.Form MantElect06 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame8 
         Caption         =   "Vehículos Especiales disponibles"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
...
Dim cboComunicadoListIndex As Integer
...
Private Sub Combo3_Click()
   ...
   If cboComunicadoListIndex <> Combo3.ListIndex And FlexPartAsignados.Rows > 2 Then
         If MsgBox("Si selecciona otro Comunicado se perderán los partes cargados hasta el momento en la grilla inferior. ¿ Desea continuar ? ", vbYesNo, "Nro de Comunicado") = vbYes Then
            ...
            If Combo3.ListIndex <> 0 Then
               mNroComunicado = Trim(Combo3.Text)
               cargarGrillaConPartesDeComunicado mNroComunicado, "-1"
            Else
               cargarGrillaConPartesOperaciones "-1"
            End If
         Else
            Combo3.ListIndex = cboComunicadoListIndex
            
            
            
            
         End If
         cboComunicadoListIndex = Combo3.ListIndex
   Else
       mRenglonPartes = 0
      'Elimino los registros grilla superior
      For mi = FlexPartes.Rows To 3 Step -1
...
Private Sub CommandPartes_Click(Index As Integer)
   ...
   Else
      If FlexPartAsignados.Rows > 2 And mRenglonPartAsignados > 1 Then
         ...
         If Combo3.ListIndex = 0 Then
            cargarGrillaConPartesOperaciones sListaPartesSeleccionados
         Else
...
Private Sub cargarGrillaConPartesOperaciones(ByVal plistaPartesSeleccionados As String)
