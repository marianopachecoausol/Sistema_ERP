...
'MsgBox "Flex ancho: " & FlexPartAsignados.Width
'MsgBox "------ altos -------: " & FlexPartAsignados.Width
...
'--TECNICOS----------------------------------------------------------------------------------------------------------------------------
   ...
   Set mRec = mObj.oEjecutarSelect(" SELECT Codigo,Descripcion " & _
                                   ...
                                   "   MO_Tecnicos M " & _
                                   " Left Join " & _
                                   "  OT_MO_Tecnicos OM ON OM.CodMo_Tecnico = M.Codigo AND OM.IdOT = " & mIdOT & _
...
'''   Dim resultado As String
'''
'''If FlexPartAsignados.MouseCol = 0 Then
'''   If FlexPartAsignados.MouseCol = 0 And FlexPartAsignados.MouseRow > 0 Then
'''      If mRenglonPartAsignados <> 0 Then
'''         FlexPartAsignados.Row = mRenglonPartAsignados
'''         For mi = 1 To FlexPartAsignados.Cols - 1
'''            FlexPartAsignados.Col = mi
...
'''         If Not mEsOTcerrada Then
'''
'''            If FlexPartAsignados.Rows > 3 Then
'''               mCodParte = FlexPartAsignados.TextMatrix(mRenglonPartAsignados, 1)
...
'''                     mRenglonPartAsignados = 0
'''                  Else
'''                     If Trim(FlexPartAsignados.TextMatrix(mRenglonPartAsignados, 1)) <> "" Then
'''                        FlexPartAsignados.TextMatrix(mRenglonPartAsignados, 1) = ""
'''                        FlexPartAsignados.TextMatrix(mRenglonPartAsignados, 2) = ""
'''                        mRenglonPartAsignados = 0
'''                     End If
'''                  End If
'''               End If
...
'''   Else
'''      FlexPartAsignados.Row = mRenglonPartAsignados
'''      If FlexPartAsignados.Row <> 0 Then
'''         For mi = 1 To FlexPartAsignados.Cols - 1
'''            FlexPartAsignados.Col = mi
'''            FlexPartAsignados.CellBackColor = vbWhite
'''         Next
...
'''Backup sentencia igual a la siguiente (por las dudas)
'''   Set mRec = mObj.oEjecutarSelect(" SELECT * FROM ( " & _
'''                                       " SELECT DISTINCT RD.IdRele,R.Parte,FechaSolic,CodEdificio,descripcion,Prioridad,R.SectorAire, FechaIniAsist " & _
'''                                       " FROM Registros R " & _
'''                                          " Inner Join MailsxElectrico M ON R.SectorAire = M.SectorAire " & _
'''                                          " Left Join OT_Partes OT ON OT.Parte = R.Parte " & _
