 ...
 Dim CodUbicacion As Integer
   Select Case Index
      ...
      Case 6 'Eliminar
         ...
         If mRec1.EOF Then
            If MsgBox("¿Está seguro de dar de baja la Ubicación?", vbYesNo, "Atención") = vbYes Then
            ...
            End If
         Else
           MsgBox "NO es posible Eliminar esta Ubicación!!! " & vbCrLf & "Aun contiene productos en stock.", vbCritical, sMessage
         End If
         mRec1.Close
...
mSalir = False
mRec.MoveFirst
'Me posiciono en la ubicacion pasada como parámetro.
Do While Not mRec.EOF And Not mSalir
