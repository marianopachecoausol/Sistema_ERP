 ...
 Dim CodProducto As Integer
   Select Case Index
      ...
      Case 6 'Eliminar
         ...
         " where M.CodProducto = '" & Trim(Text1(0).Text) & "' " & _
...
'               mObj.xDelTabla "Marca", "WHERE CodTipoVehic = '" & Left(Combo1(0).Text, 2) & "' AND CodMarca = '" & Text1(0).Text & "'"
            ...
            End If
         Else
            MsgBox "NO es posible eliminar el producto!!! " & vbCrLf & "Aún existen Ubicaciones con stock.", vbCritical, sMessage
         End If
         mRec1.Close
      ...
      Set mRec1 = mObj.oProductos()
         mData.Execute ("CREATE TABLE Reportes (Codigo TEXT,CodigoSap TEXT,Descripcion TEXT, UnidadMedida TEXT, Fecha_Baja TEXT)")
         Do While Not mRec1.EOF
            mData.Execute "insert into Reportes (Codigo,CodigoSap,Descripcion,UnidadMedida, Fecha_Baja) values ('" & mRec1!Codigo & "','" & mRec1!CodigoSap & "','" & mRec1!descripcion & "','" & mRec1!UnidadMedida & "','" & mRec1!Fecha_Baja & "')"
            mRec1.MoveNext
         Loop
      mRec1.Close
